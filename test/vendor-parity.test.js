...
describe('vendored receipt-verifier core', () => {
  ...
  it('the pin names a revision for every vendored file', () => {
    ...
    assert.match(header, /source_commit: 523e0a2b822088990f500b9eea3868309439c53c/,
      'the pin does not name the released commit');
    assert.match(header, /receipt-verifier \*\*v1\.0\.3\*\*/,
  ...
  it('each vendored core file is byte-identical to the SIGNED receipt-verifier v1.0.3', (t) => {
    ...
    assert.equal(peeled.stdout.trim(), '523e0a2b822088990f500b9eea3868309439c53c',
