 ...
 */
import type { GuardOutcome, ApprovedVerdict, UnavailableVerdict, ReceiptVerifiedEnvelope, DecisionResultEnvelope } from '../src/types';
...
const f1: GuardOutcome<string> = { executionAttempted: true, executed: true, enforced: true, result: 'x', verdict: { kind: 'BLOCK', action: 'STOP', envelope: env, receiptVerified: true }, preflighted: true };
...
const ok3: GuardOutcome<string> = { executionAttempted: true, executed: true, enforced: true, result: 'x', verdict: ok1, preflighted: true };
