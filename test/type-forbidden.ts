 ...
 */
import type { GuardOutcome, ApprovedVerdict, UnavailableVerdict, ReceiptVerifiedEnvelope, DecisionResultEnvelope, GuardExecutionProof, FreshnessBasis, ConditionalWriteBasis, CommitObservation } from '../src/types';
...
declare const commit_observation: CommitObservation;
...
const f1: GuardOutcome<string> = { executionAttempted: true, executed: true, enforced: true, result: 'x', verdict: { kind: 'BLOCK', action: 'STOP', envelope: env, receiptVerified: true }, preflighted: true, proof, freshness, conditional_write, commit_observation };
...
const ok3: GuardOutcome<string> = { executionAttempted: true, executed: true, enforced: true, result: 'x', verdict: ok1, preflighted: true, proof, freshness, conditional_write, commit_observation };
